<#
.NOTE
  DEPRECATED: This intermediate script has been superseded by 'tools/pipeline/organize_by_outline.ps1'.
  Please use the canonical organizer script going forward. This file is retained temporarily for reference.
#>
